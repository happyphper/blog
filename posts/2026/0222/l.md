...
# Flutter for OpenHarmony：l — 极简的全局日志打印工具

![l](images/l.png)

## 前言

在鸿蒙（OpenHarmony）多端流转的复杂环境下，杂乱的 `print` 日志往往会淹没关键调试信息。`l` 是一款秉持极简主义设计的日志工具，它抛弃了繁琐的配置，提供格式化、级别挂置及标签区分等核心功能，帮助开发者极其高效地管理控制台输出。
