  ...
  <footer id="main-footer" class="main-footer">
    <div class="footer-content">
      <div class="copyright">
        ...
        <a class="icp link" href="https://beian.miit.gov.cn/" ref="nofollow" target="_blank">
          <i class="iconfont icon-safe" />
          {{ theme.icp }}
        </a>
        <a class="icp link" :href="theme.beiAnLink" ref="nofollow" target="_blank">
          <img class="iconfont" src="/images/police.png" alt="beian" />
          {{ theme.beiAn }}
        </a>
        <a
          class="upyun link"
          href="https://github.com/happyphper"
          target="_blank"
        >
      ...
      <div class="meta">
        ...
        <a class="rss link" href="https://www.longbao.wang/rss.xml" target="_blank">
