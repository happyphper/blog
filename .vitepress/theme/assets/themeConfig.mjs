...
export const themeConfig = {
  ...
  siteMeta: {
    ...
    author: {
      ...
      email: "baronbool@163.com",
      link: "https://www.longbao.wang",
    },
  },
  // 备案信息
  icp: "京ICP备2023017370号-1",
  // 备案信息
  beiAn: "京公网安备XXXX号",
  beiAnLink: "http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=1101080202xxxx",
  // 建站日期
  since: "2025-05-23",
  // 每页文章数据
  postSize: 8,
    ...
    header: [
      ...
      [
        "link",
        {
          ...
          title: "RSS",
          href: "https://www.longbao.wang/rss.xml",
        },
      ],
      // 预载 CDN
      [
  ...
  nav: [
    ...
    },
    {
      text: "我的",
      items: [
        { text: "畅所欲言", link: "/pages/thanks", icon: "chat" },
      ...
      list: [
        {
          ...
          name: "起始页",
          url: "https://nav.longbao.wang/",
        },
        {
          icon: "https://pic.efefee.cn/uploads/2024/04/08/661346d418ad7.png",
          name: "今日热榜",
          url: "https://hot.longbao.wang/",
        },
        {
          icon: "https://pic.efefee.cn/uploads/2024/04/08/66134722586fa.png",
          name: "站点监测",
          url: "https://status.longbao.wang/",
        },
      ],
    },
    {
      ...
      list: [
        {
          icon: "/images/logo/logo.png",
          name: "Home",
          url: "https://github.com/happyphper/home",
        },
      ],
    },
  ],
  ...
  footer: {
    ...
    sitemap: [
      ...
      },
      {
        text: "服务",
        items: [
          { text: "站点状态", link: "https://status.longbao.wang/", newTab: true },
          { text: "一个导航", link: "https://nav.longbao.wang/", newTab: true },
          { text: "站点订阅", link: "https://www.longbao.wang/rss.xml", newTab: true },
          {
            text: "反馈投诉",
